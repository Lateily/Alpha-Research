...
## Team Sharing Upgrade

Team sharing was approved by Junyan on 2026-07-31 as a two-week v2 trial.

The v2 shared read path is documented in:

```text
docs/llm/AI_PROGRESS_SHARED_V2.md
```
...
The local watcher remains the fallback for local development.
