...
## 通用蒸馏:六步法(Junyan ratified 2026-07-11)

Line 2 的跨行业通用形态——半导体、医药、能源、农业、消费一体适用,
不被最近热点绑架:

1. 找产业链节点。
2. 验证它是不是**能力瓶颈**(支柱 A,E1)。
3. 验证瓶颈能不能**翻译成现金流**(支柱 B,E1)。
4. 画客户/供应商/JV/共研/订单**关系边**。
5. 写 **dated catalyst** 和 **wrong-if**。
6. **先注册 paper signal,再等结果**(永不倒序)。
