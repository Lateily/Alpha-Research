...
| R-032 | U0 全市场证券注册表 | `DELIVERED_UNWIRED` | Codex+Data Agent | **PR #226**:生成器+schema+首份 20260805 实物已交付;真实注册 5,876 只,当前上市/U1 可扫描 5,537 只,退市保留 339 只。3 只新股流动性历史不足,顶层诚实为 PARTIAL。**未接线边界**:尚未进入夜链日更,R-036 全市场 E1 层尚未消费该注册表 | 全部 A 股永久注册+资格标签;原子写;重复/损坏 prior/哈希与覆盖漂移 fail-closed;selftest 17/17;Tushare `stock_basic/trade_cal/daily` 首跑完成 |
