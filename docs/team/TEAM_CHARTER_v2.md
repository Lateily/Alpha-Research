...
> **SUPERSEDED（2026-08-16）：**本文件保留为三人体制历史记录。当前六人角色、
> AIOS 模块、学习任务、接口与 Reviewer 以
> [`TEAM_CHARTER_v4.md`](TEAM_CHARTER_v4.md) 为准。若本文中的 Better/Reed/Simon
> Owner 与 v4 冲突，必须使用 v4；不得继续从本文认领新任务。
