...
class PaperExecutionAuditTests(unittest.TestCase):
    ...
    def test_behavioral_probe_matrix_executes_against_current_engine(self) -> None:
        ...
        self.assertEqual(receipt["capability_summary"]["PASS"], 4)
        self.assertEqual(receipt["capability_summary"]["FAIL"], 9)
        ...
        self.assertEqual(cases["A_SHARE_T1_SELL"]["status"], "FAIL")
