...
v1 auto mode startup (4-agent automation)
...
Terminal 2 (T2 reviewer):
  bin/agent-watch-reviewer.sh
  Standby for review tasks. Replaces interactive claude reviewer mode.

Terminal 3 (T3 codex):
  bin/agent-watch-codex.sh
  Standby for codegen tasks. Replaces interactive codex.

Terminal 4 (T4 design):
  bin/agent-watch-design.sh
  Standby for UX/UI design briefs in .agent_tasks/design/pending/.
  Replaces interactive T4 (added 2026-05-02).
