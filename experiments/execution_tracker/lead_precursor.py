...
TECH_PARENT = ["电子"]
# canonical 科技邻域。数据源(rotation_history)里同一条产业链会出现多个同义名,
# 漏一个就等于那条子线在前兆层里"消失"。CPO/PCB 是 2026 AI 链最核心的两条,
# 此前只收了「光通信模块 / 印制电路板」,而数据里真实存在的「CPO概念 / PCB /
# 先进封装 / 集成电路制造 / 集成电路封测 / 光纤概念 / 光学光电子」全部漏收 ——
# 单条 Q3 缺项即可让整个前兆层判 DATA_BLOCKED。
# 注意:光伏系(光伏概念/光伏设备/…)名字里带「光」但属新能源,不得并入科技邻域。
TECH_NEIGHBORS = [
    # 半导体
    "半导体", "半导体概念", "半导体设备", "半导体材料", "第四代半导体",
    "集成电路", "集成电路制造", "集成电路封测", "先进封装", "芯片概念",
    # CPO / 光通信
    "光通信模块", "CPO概念", "光模块", "光器件", "光芯片", "光纤概念",
    "光学元件", "光学光电子",
    # PCB / 元件
    "印制电路板", "PCB", "覆铜板", "元件", "被动元件",
    # 通信 / 终端 / 算力
    "通信设备", "通信技术", "通信终端", "通信",
    "消费电子", "品牌消费电子",
    "计算机", "计算机设备", "其他计算机设备", "服务器", "算力概念",
]
